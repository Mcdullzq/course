            ...
            <div class="form-group">
                ...
                <div class="field">
                   <input type="file" class="input w50" name="file"/>
                    <div class="tips"><img src="${obj.url1}" alt="${obj.url1}" style="width: 50px;height: 50px"/> </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="file" class="input w50" name="file"/>
                    <div class="tips"><img src="${obj.url2}" alt="${obj.url2}" style="width: 50px;height: 50px"/> </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <div class="tips"><img src="${obj.url3}" alt="${obj.url3}" style="width: 50px;height: 50px"/> </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="file" class="input w50" name="file"/>
                    <div class="tips"><img src="${obj.url4}" alt="${obj.url4}" style="width: 50px;height: 50px"/> </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="file" class="input w50" name="file"/>
                    <div class="tips"><img src="${obj.url5}" alt="${obj.url5}" style="width: 50px;height: 50px"/> </div>
                </div>
            </div>
            <div class="form-group">
