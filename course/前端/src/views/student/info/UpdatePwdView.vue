	...
	<div id="updatePwdContainer">
		<el-form label-width="120px" size="large">
			<el-form-item label="原始密码:">
				<el-input type="password" v-model="stu.oldPwd"></el-input>
			</el-form-item>
			<el-form-item label="新密码:">
				<el-input type="password" v-model="stu.stuPwd"></el-input>
			</el-form-item>
			<el-form-item label="确认密码:">
				<el-input type="password" v-model="stu.rePwd"></el-input>
			</el-form-item>
			<el-form-item>
	...
	export default{
		...
		methods:{
			doSave(){
				...
				this.stu.stuId=JSON.parse(str).stuId;
				this.$axios.post("StuInfoController/updatePwd",this.stu)
				.then(rst=>{
